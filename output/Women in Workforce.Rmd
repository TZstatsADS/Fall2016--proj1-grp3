...
as.dataframe(prop.table(table(Data$State)) - prop.table(svytable(~State, design = Data.w)))

as.dataframe(prop.table(table(Data$Income)) - prop.table(svytable(~Income, design = Data.w)))
