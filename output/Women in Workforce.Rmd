...
StateMedian$State<- recode(StateMedian$State,"statenames$code=statenames$name")
table(StateMedian$State)

map <- gvisGeoMap(data=StateMedian, locationvar = "State", numvar='Income)',options=list(width='800px',heigth='500px',colors="['0x0000ff', '0xff0000']"))
plot(map)
