...
```
We have renames and categorized multiple categories for readablilty.
```{r, echo = FALSE}
#recode OCCP
...
```
From our results, the survey weights would be insignificant relative to the data. ...
...
#Race
Over the years, there has been an increase awareness on the women wage gap and racial social issues. We wanted to understand the effects of your race could potentially have on a women's career. 
...
```
We determined that majority of the women in the workforce are white. To see how this compares to the national average, we compared this chart to the overall race breakdown of the country. Our assumption is that women should make up half of the working force for all races. 
...
Through these resulte, their is a significant gap in income for women regardless to race. 
