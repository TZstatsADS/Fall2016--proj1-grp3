...
#Finance (reduced plotly node size, add line, update titles )
...
FIN <- figure(width = NULL, height = NULL) %>%
  ly_points(Age, MEAN, data = Data_wed_FIN,
    color = Marriage, glyph = Marriage,
    hover = list(Marriage, Age))
add_trace(y = fitted(loess(MEAN ~ Age)), x = Age))
