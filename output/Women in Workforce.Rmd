...
```
For our anaylsis, we used dplyr, plyr, dplyr, rcokeh, ggplot2, plotly, car, survey, readr, and googleVis.  
...
colnames(Data) <- c("Gender","Occupation", "Work_hours", "Marriage", "Income", "Education" ,"Parental_Occupation", "Race", "State", "Children", "Weight","Age","Region","Division")
```
...
```{r}
MotherWorking=select(Data_women_age, Income,Children,Work_hours)
#detach(package:plyr)
